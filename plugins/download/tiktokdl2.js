...
async function handler(m, { sock }) {
    ...
    try {
        ...
        if (result.type === 'photo' && result.slides.length > 0) {
            ...
            for (let i = 0; i < result.slides.length; i++) {
                ...
                try {
                    ...
                    console.error(`[TikTok2] Error al descargar diapositiva ${i}:`, e.message)
                }
            }
        ...
        throw new Error('No se encontró contenido multimedia para descargar')
